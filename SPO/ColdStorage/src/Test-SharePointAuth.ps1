...
param(
    [string]$TenantId = "8f04bc3b-3841-4627-b64c-594c3c7ddaac",
    [string]$ClientId = "488592e0-ccc4-4633-86e4-94be1affa035",
    [string]$ClientSecret = "l2K8Q~7.tKGzaXYlOV6mw4cBVn5u~IqHt.Gngcho",
    [string]$SharePointUrl = "https://mercadona365.sharepoint.com"
)
