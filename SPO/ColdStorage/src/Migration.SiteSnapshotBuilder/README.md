...
| `AzureAd:TenantId` | Azure AD Tenant ID (GUID) | `8f04bc3b-...` |
| `AzureAd:ClientID` | App Registration Client ID | `488592e0-...` |
| `AzureAd:Secret` | App Registration Client Secret | `l2K8Q~7...` |
